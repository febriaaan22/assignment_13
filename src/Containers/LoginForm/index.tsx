...
const LoginForm: React.FC = () => {
  ...
  return (
    <Card title="Login" style={{padding:'20px'}}>
      ...
      >
        ...
        <Form.Item>
          <Button type="primary" htmlType="submit" className="login-form-button" style={{margin:'15px'}}>Login</Button>
          <Button type="primary" htmlType="submit" className="login-link" onClick={()=>{navigate('/register')}} style={{margin:'15px'}}>Register</Button>
        </Form.Item>
      </Form>
    </Card>
  );
